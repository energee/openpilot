...
def create_steering_control(apply_steer, crv, crv5g, civichatch, idx):
  ...
  if crv:
    ...
    if crv5g or civichatch:
      commands.append(make_can_msg(0xe4, msg_0xe4, idx, 2))
    else:
      commands.append(make_can_msg(0xe4, msg_0xe4, idx, 0))
  return commands

def create_ui_commands(pcm_speed, hud, civic, accord, crv, crv5g, civichatch, idx):
