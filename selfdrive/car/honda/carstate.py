...
elif car_fingerprint in (CAR.CIVIC, CAR.CIVIC_HATCH, CAR.CRV_4G, CAR.ACURA_RDX, CAR.CRV_5G):
...
class CarState(object):
  ...
  def update(self, cp):
    ...
    if self.CP.carFingerprint in (CAR.CIVIC, CAR.CIVIC_HATCH, CAR.ODYSSEY, CAR.CRV_5G):
